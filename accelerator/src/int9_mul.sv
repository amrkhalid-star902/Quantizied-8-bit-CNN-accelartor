...
module int9_mul(
  ...
  assign tmp_A_1 = io_b;
  assign tmp_A = {{21{tmp_A_1[8]}}, tmp_A_1};
  assign tmp_B_1 = io_a;
  assign tmp_B = {{9{tmp_B_1[8]}}, tmp_B_1};
  assign tmp_D_1 = {tmp_D[8],tmp_D};
  ...
  assign abNeg = (((|io_a) && (|io_b)) && (io_a[8] ^ io_b[8]));
  assign dsp_A = tmp_A;
  assign dsp_B = tmp_B;
  assign tmp_D = io_c;
  assign dsp_D = {tmp_D_1,18'h00000};
  assign dsp_C = {{29'h00000000,abNegReg},18'h00000};
  assign io_ab = dsp_P[17 : 0];
  assign io_ac = tmp_io_ac[17 : 0];
